    ...
    <div>
      ...
      <div className="flex">
        ...
        <div className="left">
          <div className="menu">
            ...
            <ul className="menu-item">
              ...
              <li><Link to="/mypage/posts">나의 글</Link></li>
              <li><Link to="/mypage/interest">관심 공연</Link></li>
              <li><Link to="/mypage/password">비밀번호 변경</Link></li>
              <li><Link to="/logout">로그아웃</Link></li>
              <li><Link to="/withdraw">회원 탈퇴</Link></li>
            </ul>
          </div>
          <div>
            <h2 className="menu-name">서비스 약관</h2>
            <ul className="menu-item">
              <li><Link to="/terms">서비스 이용 약관</Link></li>
        ...
        <div className="right-top">
          <p className="hello">
            안녕하세요 <span className="text-orange-500">{user.nickname}</span>님!
          </p>
            ...
            <div className="user-favorite">
              {user.favorites.map((show) => (
                <div key={show.id} className="user-favorite-content">
                  <img src={show.thumbnail} alt={show.title} className="user-favorite-poster" />
